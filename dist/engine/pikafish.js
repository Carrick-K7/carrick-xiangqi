// Browser-compatible version of Pikafish
var Pikafish = (() => {
  var _scriptDir = typeof __dirname !== 'undefined' ? __dirname : '';
    ...
    function (Pikafish) {
      ...
      (function () {
        ...
        var loadPackage = function (metadata) {
          ...
          var PACKAGE_NAME = 'emscripten/pikafish.data';
          ...
          function fetchRemotePackage(packageName, packageSize, callback, errback) {
            // Browser-compatible: use fetch instead of fs.readFile
            if (typeof window !== 'undefined' && window.fetch) {
              ...
              errback(new Error('No fetch or fs available'));
            }
          }
          ...
          function runWithFS() {
            ...
            function processPackageData(arrayBuffer) {
              ...
              Module['removeRunDependency']('datafile_emscripten/pikafish.data');

            };
            Module['addRunDependency']('datafile_emscripten/pikafish.data');
        ...
        loadPackage({
          "files": [{"filename": "/pikafish.nnue", "start": 0, "end": 4103914}],
          "remote_package_size": 4103914
        });
...
// the dependencies are met.
      ...
      function createWasm() {
        ...
        function instantiateAsync() {
          // console.log('instantiateAsync', wasmBinaryFile);

          if (!wasmBinaryFile || typeof WebAssembly.instantiateStreaming !== 'function' || isDataURI(wasmBinaryFile)) {
...
// Uint8Array otherwise). If filename is not a base64 data URI, returns undefined.
      ...
      /** @type {function(...*):?} */
      var _wasm_uci_execute = Module["_wasm_uci_execute"] = function () {
        return (_wasm_uci_execute = Module["_wasm_uci_execute"] = Module["asm"]["wasm_uci_execute"]).apply(null, arguments);
      };
