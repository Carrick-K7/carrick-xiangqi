...
const moves = ["炮二平五", "炮8平5", "馬二进三", "馬8进7", "車一进一", "车9平8", "車一平六", "车8进6", "車六进七", "马2进1", "車九进一", "炮2进7", "炮八进五", "马7退8", "炮五进四"];

let board = initBoard();

console.log("初始黑方九宫:");
console.log("y=0: 士(3) 將(4) 士(5)");
...
console.log("\n执行 '士6进5':");
const r1 = executeMove(board, "士6进5", 15);
if (r1.success) {
  console.log(`  士从 (${r1.fromX},${r1.fromY}) 移动到 (${r1.toX},${r1.toY})`);
  console.log("  y=0:", board[0][3]?.type, board[0][4]?.type, board[0][5]?.type);
  console.log("  y=1:", board[1][3]?.type, board[1][4]?.type, board[1][5]?.type);
}
